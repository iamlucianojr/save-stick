...
public class Truck extends Vehicle implements IsCollisionable {
    private static final Color COLOR = Color.BLUE;
    private static final String PATH_IMAGE = "/var/www/SaveStick/src/br/edu/ifc/luciano/savestick/assets/truck.png";
    private static BufferedImage bufferedImage;
    private static final int SPEED = 10;

    public void setImage() {
        try {
            bufferedImage = ImageIO.read(new File(PATH_IMAGE));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
